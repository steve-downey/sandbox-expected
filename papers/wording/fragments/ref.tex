\rSec3[expected.ref]{Partial specialization of expected for reference types}

\rSec4[expected.ref.general]{General}
...
\rSec4[expected.ref.cons]{Constructors}
...
\rSec4[expected.ref.assign]{Assignment}
...
\pnum
\remarks
Assignment rebinds: assigning to an \tcode{expected<T&, E>} that holds a value changes which object it refers to. It never assigns through to the referent.

\pnum
This operator is trivial. Copy assignment (trivial path)
\end{itemdescr}
...
\rSec4[expected.ref.obs]{Observers}
...
\rSec4[expected.ref.monadic]{Monadic operations}
...
\rSec4[expected.ref.eq]{Equality operators}
