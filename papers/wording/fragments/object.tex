\rSec3[expected.expected]{Class template expected}

\rSec4[expected.object.general]{General}
...
\rSec4[expected.object.cons]{Constructors}
...
\rSec4[expected.object.assign]{Assignment}
...
\rSec4[expected.object.swap]{Swap}
...
\pnum
\constraints
\tcode{is_swappable_v<T>} is \tcode{true} and (\tcode{is_reference_v<E>} or \tcode{is_swappable_v<E>}) is \tcode{true}, and \tcode{is_move_constructible_v<T> && is_move_constructible_v<E>} is \tcode{true}, and \tcode{is_nothrow_move_constructible_v<T> || is_nothrow_move_constructible_v<E>} is \tcode{true}.
...
\rSec4[expected.object.obs]{Observers}
...
\rSec4[expected.object.monadic]{Monadic operations}
...
\rSec4[expected.object.eq]{Equality operators}
