\rSec3[expected.void]{Partial specialization of expected for void types}

\rSec4[expected.void.general]{General}
...
\rSec4[expected.void.cons]{Constructors}
...
\rSec4[expected.void.dtor]{Destructor}
...
\rSec4[expected.void.assign]{Assignment}
...
\pnum
\constraints
\tcode{is_swappable_v<E>} is \tcode{true} and \tcode{is_move_constructible_v<E>} is \tcode{true}.
...
\rSec4[expected.void.obs]{Observers}
...
\rSec4[expected.void.monadic]{Monadic operations}
...
\rSec4[expected.void.eq]{Equality operators}
