\rSec3[expected.unexpected]{Class template unexpected}

\rSec4[expected.un.general]{General}
...
\rSec4[expected.un.cons]{Constructors}
...
\rSec4[expected.un.ref]{Partial specialization unexpected<E&>}
